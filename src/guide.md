...
Following the Try Curling session new curlers will be directed to attend the three session Beginners course which will develop the basic skills further while introducing other curling basics such as weight control, sweeping, etc.
The fee for all coaching course sessions will be £10.
...
<centred-content-block>
  ...
  <img src="/images/therink.avif" alt="Club main pitch" />
